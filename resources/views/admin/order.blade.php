...
@section('main')
    ...
    <div class="w-100 mx-auto">
        <div class="flex flex-col items-center justify-center w-100 mt-20">
            <div class="text-[#2DBE78] font-semibold text-2xl mb-4">Order Menu</div>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2 ">
                                    <div class="flex justify-center gap-3">
                                        <button onclick="window.location.href='/admin/order/detail/{{ $data->id }}'"
                                            class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                            type="button" data-modal-toggle="popup-modal">
                                            Detail
                                        </button>
                                        <button onclick="window.location.href='/admin/order/edit/{{ $data->id }}'"
